...
const Profile = () => {
  ...
  const [noOfDays, setNoOfDays] = useState<any>(null);
  const [noOfHours, setNoOfHours] = useState<any>(null);
  ...
  const submitHireMe = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (response.status === 200 && data.success === true) {
      setLoader(false);
      setShowModal(false);
      toast.success("Hire Me Successful", {
        position: "top-center",
        duration: 5000,
  ...
  return (
    <Layout active="partner">
                ...
                <div className="flex items-center w-full px-4 gap-10">
                  ...
                  <div className="flex flex-col justify-center gap-1 w-80">
                    ...
                    <div className="text-xs text-[#737B7D]">
                      {userData?.user?.physical_address}
                    </div>
                    ...
                    isLoggedIn === false ? (
                      <div className="w-fit pt-4">
                        <button
                          ...
                          className="text-white bg-[#520B1F] border border-[#520B1F] font-bold w-full px-4 py-2 text-sm rounded-full"
                        >
                          Hire Me
                        </button>
                      </div>
            ...
            <div>
              <div className="flex gap-4 pb-10 border-b-2 border-[#520b1f3a]">
                ...
                <div className="flex flex-col justify-center gap-1">
                  <div className="text-lg text-[#520B1F] font-bold">
                    Hire {userData?.user?.username} for your next project
                  </div>
                  <div className="text-sm text-[#737B7D]">
                    Provide some details below we will let you know if{" "}
                    {userData?.user?.username} is available to work on your
                    awesome project
                  </div>
                </div>
              </div>
              <form onSubmit={submitHireMe}>
                    ...
                    {categories.map((cat: any, index: number) => (
                      <div className="flex items-center me-4">
                        <input
                          ...
                          type="checkbox"
                          checked={
                            checks?.length > 0 ? checks.includes(cat.id) : false
                          }
                          value=""
                ...
                <div className="py-8">
                  ...
                  <div className="grid grid-cols-1 gap-4">
                    <div className="">
                      <label className="text-sm font-bold text-[#5C5C5C]">
                        Give a short description of the services to be provided.
                        Remeber to include anything that isn’t available in this
                        form.
                      </label>
                      <textarea
                        title="description"
      ...
      {showRelatedModal && (
        <Modal
          bigModal={true}
          handleClose={() => setShowRelatedModal(false)}
          Content={
            <div>
