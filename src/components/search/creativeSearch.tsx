                    ...
                    {featuredCreatives.map((creative:any, index:number) => (
                        ...
                        <div className='flex items-center border-b-2 pb-10 gap-6 w-full'>
                            ...
                            <div className='flex flex-col justify-center gap-1 w-80'>
                                <div className='text-xs font-bold text-[#520B1F]'>{creative.username}</div>
                                <div className='text-xs text-[#737B7D]'>{creative.physical_address}</div>
                            ...
                            <button type="button" title="forward" className="flex">
