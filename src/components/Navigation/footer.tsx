        ...
        <div className=''>
          ...
          <div className='grid grid-cols-2 pt-2 gap-x-4 w-full lg:gap-x-10 gap-y-10 md:justify-items-center md:grid-cols-4 lg:grid-cols-5'>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <a href='/#categories' className='font-semibold text-gray-100 hover:text-gray-300'>Categories</a>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <a href='/search' className='font-semibold text-gray-100 hover:text-gray-300'>Product</a>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <a href='/search' className='font-semibold text-gray-100 hover:text-gray-300'>Suggestions</a>
            </div>
            <div className='flex flex-col gap-4'>
                <div className='text-white font-bold text-lg'>Partner</div>
                <a href='/partners' className='font-semibold text-gray-100 hover:text-gray-300'>Brand</a>
                <a href='/promo-pack' className='font-semibold text-gray-100 hover:text-gray-300'>Offers</a>
            </div>
          </div>
        </div>
      </div>
